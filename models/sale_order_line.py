...
class SaleOrderLine(models.Model):
    ...
    prepress_proof_id = fields.Many2one('prepress.proof', string='Prepress proof', readonly=True,ondelete="restrict")
    ...
    def write(self, vals):
        ...
        for each in self:
            if each.state == 'sale' and each.product_id.type == 'product' and each.product_id.bat_product and not each.prepress_proof_id:
